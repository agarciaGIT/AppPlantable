({
            ...
            action.setCallback(this, function(response) { 
                ...
                if(res == "Error"){
                   ...
                   component.set("v.ErrorMessage","Billing Address Not found"); 
                  	...
                  	component.set("v.ScreenSelection","Deferral Selection");
    ...
    handleChange : function(component, event, helper) {
        ...
        if(selval == null){
            component.set("v.ErrorMessage","Regisatration for the Exam you want to defere");  
            return;
        }
        ...
        if(FreeDeferral == 'No' && ChargeProcess == null){
            ...
            if(selval == 'Yes'){ 
                ...
                if(FromGroup != 'None'){
                    ...
                    component.set("v.ErrorMessage","Please Select Deferral From");
                }
            }
        ...
        component.set("v.SelectedChargeProcessing",null); 
    },BackButtonDeferral: function(component, event, helper) { 
        component.set("v.ErrorMessage","");
        component.set("v.SelectedcurrentExamGrp",null);
        component.set("v.SelectedFreeDeferral",null);
        component.set("v.SelectedChargeProcessing",null);
