({
    ...
    addSurvey: function(component, event, helper) {
        ...
        component.set('v.goalMsg', '');
        component.set('v.poisonMsg', '');
        ...
        for(var i = 0; i < myInputs.length; i++) {
            ...
            var validFormPart = helper.validateInput(component, inputField);
            if(validFormPart == false)
                validForm = false;
        }
        ...
        for(var i = 0; i < myInputs.length; i++) {
            ...
            var required = inputField.get("v.required");
        ...
        var strGoals = "";
        if(component.get("v.GoalLoseWeight") == true) {
            strGoals += "Weight loss;";
        }
        if(component.get("v.GoalLoseBellyFat") == true) {
            strGoals += "Loss of belly fat;";
        }
        if(component.get("v.GoalImproveEnergy") == true) {
            strGoals += "Improved energy;";
        }
        if(component.get("v.GoalImproveMind") == true) {
            strGoals += "Improve mind clarity;";
        }
        if(component.get("v.GoalImproveHealth") == true) {
            strGoals += "Improved blood work;";
        }
        if(component.get("v.GoalNewLifeStyle") == true) {
            strGoals += "Sustainable lifestyle change;";
        }
        if(component.get("v.GoalConvenience") == true) {
            strGoals += "Ease and convenience;";
        }
        objClassController.healthSurveyItem.Whats_in_it_for_you__c = strGoals;        
        
        if(strGoals == "") {
            validForm = false;
            component.set('v.msg', "Goal is required");
            component.set('v.goalMsg', "Goal is required");
        }
        
        var strPoison = "";
        if(component.get("v.PoisonNoSugar") == true) {
            strPoison += "No added sugar;";
        }
        if(component.get("v.PoisonNoGrains") == true) {
            strPoison += "No refined grains;";
        }
        if(component.get("v.PoisonNoSnacks") == true) {
            strPoison += "No or low alcohol;";
        }
        if(component.get("v.PoisonNoAlcohol") == true) {
            strPoison += "No crappy snacks;";
        }        
        objClassController.healthSurveyItem.Whats_your_poison__c = strPoison;
        
		if(strPoison == "") {
            validForm = false;
            component.set('v.msg', "What’s your poison is required");
            component.set('v.poisonMsg', "What’s your poison is required");
        }        
        ...
        if(validForm == true) {
            ...
            // Fix Values;
            objClassController.healthSurveyItem.Height_Feet__c = parseInt(objClassController.healthSurveyItem.Height_Feet__c); 
            objClassController.healthSurveyItem.Height_Inches__c = parseInt(objClassController.healthSurveyItem.Height_Inches__c);
